...
const program = [
  { icon: "GraduationCap", title: "Мастер-класс по методу", desc: "На тренинге вы наглядно поймёте, как работает Access Bars: 32 точки на голове, мягкое прикосновение к которым запускает глубокое расслабление и освобождение." },
...
Тренинг Access Bars, который поможет понять, как работает метод — освобождение от внутренних ограничений и развитие потенциала каждого члена семьи.
          </p>
          <Button
            size="lg"
